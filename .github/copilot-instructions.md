...
- **Why this structure**: separation of API and UI simplifies local dev and deployment. Frontend build step runs a sitemap generator (`scripts/generate-sitemap.mjs`) before `npm run build`.
...
- **Examples to copy from**:
  ...
  - Adding a route in frontend: add a page component under `frontend/src/pages/` and register the route in `frontend/src/App.js`.
