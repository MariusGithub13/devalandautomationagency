          ...
          <div className="grid lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8">
                {/* Related Articles - Only show if there are related posts */}
                {blogPosts.filter(p => p.id !== post.id && p.category === post.category).length > 0 && (
                  <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300 mb-8">
