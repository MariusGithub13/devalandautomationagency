...
const links = {
  ...
  secondarySocialIcons: [
    ...
    { href: "https://renewableenergy-directory.netlify.app/", Icon: Globe, label: "Renewable Directory" },
  ...
  seoTextLinks: [
    ...
    ["Renewable Energy Directory", "https://renewableenergy-directory.netlify.app/"],
