            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <div className="mt-6 flex flex-col items-start space-y-3">
                <a
                  ...
                  className="inline-block"
                >
                  <img src="/images/sol.png" alt="SOL" width="128" height="128" className="h-32 object-contain rounded-sm shadow border border-gray-200 bg-white p-1" />
                ...
                <a
                  ...
                  className="inline-block"
                >
                  <img src="/images/sal.png" alt="SAL" width="128" height="128" className="h-32 object-contain rounded-sm shadow border border-gray-200 bg-white p-1" />
