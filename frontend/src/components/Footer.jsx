            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <div className="mt-6 flex flex-col items-start space-y-3">
                ...
                <a
                  ...
                  className="inline-block"
                >
                  <img src="/images/EU Consumer Redress.svg" alt="Consumer Redress in the EU" className="h-12 w-auto object-contain rounded-sm shadow border border-gray-200 bg-white p-1" />
